			...
			<div class="container">
				<div class="row align-items-center mb-5">
					<div class="col-xl-12 col-lg-12 col-md-12 col-12">
						<div class="py-10 rounded-top" style={{
							background:`url(${coverImg})no-repeat`,
              backgroundSize: 'cover'}}>
						</div>
						<div class="bg-white pt-2 pb-0 rounded-bottom shadow-sm
                                row g-0">
							...
							<ul class="nav nav-lt-tab mt-2" id="pills-tab"
								...
								>
									<a class="nav-link active" href="author-list.html"
									>Listings </a>
								</li>
								<li class="nav-item" >
									<a class="nav-link" href="author-reviews.html">Reviews</a>
								</li>
								<li class="nav-item"  >
									<a class="nav-link" href="author-favourite.html"
									>Favourite</a>
								</li>
							</ul>
						</div>
				...
				<div class="row">
					<div class="col-12 mb-6">
						<h2 class="mb-0">David’s listings
						</h2>
					</div>
					...
					<div class="col-xl-4 col-md-6 col-12">
						<div class="mb-6">
							<div class="position-relative">
								<a href="list-single.html">
									<img src="../assets/images/listing-img-3.jpg" alt="Rentkit Directory & Listing Bootstrap 5 Theme" class="w-100 rounded-3" />
								</a>
								<div class="btn-wishlist"></div>
							</div>
							<div class="mt-3">
