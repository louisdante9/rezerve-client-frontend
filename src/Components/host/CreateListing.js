                ...
                <form action='#'>
                  ...
                  <div className='row mb-8'>
                    ...
                    <div className='col-12'>
                      ...
                      {errors.propertyName && (
                        <small className='errors'>{errors.propertyName}</small>
                      )}
                    </div>
                    {/* <!-- property type  --> */}
                    <div className='col-12'>
                      ...
                      {errors.propertyGroup && (
                        <small className='errors'>{errors.propertyGroup}</small>
                      )}
                    </div>
                    <div className='col-12'>
                      <div className='mb-3'>
                    ...
                    <div className='col-12'>
                      <div className='mb-3'>
                        <label htmlFor='privacyType' className='form-label'>
                      ...
                      {errors.privacyType && (
                        <small className='errors'>{errors.privacyType}</small>
                      )}
                    </div>
                    ...
                    <div className='col-md-6 col-12'>
                      ...
                      {errors.pricePerNight && (
                        <small className='errors'>{errors.pricePerNight}</small>
                      )}
                    </div>
                  </div>
                  {/* <!-- Step 2 --> */}
                  <div className='row mb-8'>
                    ...
                    <NumberInput
                      num={values.noOfguest}
                      label='noOfguest'
                      title='Guests'
                      updater={setFieldValue}
                    />
                    <NumberInput
                      num={values.noOfRooms}
                      label='noOfRooms'
                      title='Bedrooms'
                      updater={setFieldValue}
                    />
                    <NumberInput
                      num={values.noOfBaths}
                      label='noOfBaths'
                      title='Bathrooms'
                      updater={setFieldValue}
                    />
                  ...
                  <div className='row mb-8'>
                    ...
                    <div className='col-lg-12 mb-8'>
                      <div id='editor' ref={textInput}></div>
                    </div>
                  ...
                  <div className='row mb-8'>
                    ...
                    {errorMsg.image && <small className='errors'>{errorMsg.image}</small>}
                  </div>
