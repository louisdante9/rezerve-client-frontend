...
const Profile = () => {
  ...
  const { listings, limit, offSet, totalPage } = useSelector(
    (state) => state.getListings
  );
  // console.log(listings, "homeOwnerBookings");
  const {
    user: { id },
  ...
  useEffect(() => {
    ...
    fetchUserProfile();
    dispatch(getHomeOwnerApartment(id));
  }, [dispatch, id]);
          ...
          <div className='container'>
            <div className='row align-items-center mb-5'>
              <div className='col-xl-12 col-lg-12 col-md-12 col-12'>
                ...
                <div className='bg-white pt-2 pb-0 rounded-bottom shadow-sm row g-0'>
                  <div className='offset-xl-3 col-xl-6 col-md-12 col-12 mb-4'>
                    <div className='text-center position-relative mt-n10'>
                      <img
                        src={avatar}
            ...
            {subNavs.apartments && (
              <Listings firstname={"Your"} bookings={listings} limit={limit} offSet={offSet} totalPage={totalPage}/>
            )}
            {subNavs.bookings && (
              <Listings firstname={"Your"} bookings={homeOwnerBookings} />
            )}
